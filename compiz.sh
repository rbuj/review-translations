...
WORK_PATH=$PWD
BASE_PATH=${WORK_PATH}/compiz
BASE_PATH_RPM=${WORK_PATH}/compiz/rpm
LIST=${WORK_PATH}/list/compiz.list
...
function usage {
    echo "This script downloads the translation of Compiz"
...
function report {
    ...
    HTML_REPORT=${WORK_PATH}/compiz-report.html
    cat << EOF > ${HTML_REPORT}
<!DOCTYPE html>
