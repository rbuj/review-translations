...
WORK_PATH=$PWD
BASE_PATH=${WORK_PATH}/geany
BASE_PATH_RPM=${WORK_PATH}/geany/rpm
LIST=${WORK_PATH}/list/geany.list
...
function usage {
    echo "This script downloads the translation of geany"
...
function report {
    ...
    HTML_REPORT=${WORK_PATH}/geany-report.html
    cat << EOF > ${HTML_REPORT}
<!DOCTYPE html>
