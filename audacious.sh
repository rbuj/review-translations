...
WORK_PATH=$PWD
BASE_PATH=${WORK_PATH}/audacious
BASE_PATH_RPM=${WORK_PATH}/audacious/rpm
LIST=${WORK_PATH}/list/audacious.list
...
function usage {
    echo "This script downloads the translation of audacious"
...
function report {
    ...
    HTML_REPORT=${WORK_PATH}/audacious-report.html
    cat << EOF > ${HTML_REPORT}
<!DOCTYPE html>
